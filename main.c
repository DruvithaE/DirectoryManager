...
int main() {
  printf("\x1b[2J\x1b[1;1H"); // when this printf statement is executed, it clears the entire terminal screen and moves the cursor to the top-left corner (row 1, column 1).
